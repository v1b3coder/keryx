...
// points at the local demo server (http://localhost:8000); the original
// post URLs are kept in `source` for attribution (shown as plain text on the
// local permalink pages, never as links inside the signed content).
